...
import { Code2, Smartphone, Server, Blocks, Database, Cloud } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    description: "Scalable server-side solutions with robust APIs and efficient data processing.",
  ...
  },
  {
    ...
    description: "Deployment, hosting, and infrastructure management on modern cloud platforms.",
    tech: "AWS, Vercel, Supabase"
  },
  {
    icon: Blocks,
    title: "Consulting & Architecture",
    description: "Technical guidance and architecture planning for complex projects.",
